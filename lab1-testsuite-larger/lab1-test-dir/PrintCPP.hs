...
instance Print Def where
  prt i e = case e of
    DFunc type_ id args stms -> prPrec i 0 (concatD [prt 0 type_, prt 0 id, doc (showString "("), prt 0 args, doc (showString ")"), doc (showString "{"), prt 0 stms, doc (showString "}")])
  prtList _ [] = (concatD [])
...
instance Print Exp where
  prt i e = case e of
    ...
    EIndex id1 id2 -> prPrec i 15 (concatD [prt 0 id1, doc (showString "::"), prt 0 id2])
    EQuali id1 id2 -> prPrec i 15 (concatD [prt 0 id1, doc (showString "["), prt 0 id2, doc (showString "]")])
    EPIncr exp -> prPrec i 14 (concatD [prt 15 exp, doc (showString "++")])
    EPDecr exp -> prPrec i 14 (concatD [prt 15 exp, doc (showString "--")])
    EDeref id -> prPrec i 14 (concatD [doc (showString "*"), prt 0 id])
    EDot id1 id2 -> prPrec i 14 (concatD [prt 0 id1, doc (showString "."), prt 0 id2])
    EArrow id1 id2 -> prPrec i 14 (concatD [prt 0 id1, doc (showString "->"), prt 0 id2])
    EIncr exp -> prPrec i 13 (concatD [doc (showString "++"), prt 14 exp])
    EDecr exp -> prPrec i 13 (concatD [doc (showString "--"), prt 14 exp])
    ELogNeg exp -> prPrec i 13 (concatD [doc (showString "!"), prt 16 exp])
    ...
    ESm exp1 exp2 -> prPrec i 9 (concatD [prt 9 exp1, doc (showString "<"), prt 10 exp2])
    EGt exp1 exp2 -> prPrec i 9 (concatD [prt 9 exp1, doc (showString ">"), prt 10 exp2])
    ESmEq exp1 exp2 -> prPrec i 9 (concatD [prt 9 exp1, doc (showString "<="), prt 10 exp2])
    ...
    EAssPlus exp1 exp2 -> prPrec i 2 (concatD [prt 3 exp1, doc (showString "+="), prt 2 exp2])
    EAssMinus exp1 exp2 -> prPrec i 2 (concatD [prt 3 exp1, doc (showString "-="), prt 2 exp2])
    ECond exp stm1 stm2 -> prPrec i 2 (concatD [prt 3 exp, doc (showString "?"), prt 0 stm1, doc (showString ":"), prt 0 stm2])
  prtList _ [] = (concatD [])
  prtList _ [x] = (concatD [prt 0 x])
  prtList _ (x:xs) = (concatD [prt 0 x, doc (showString ","), prt 0 xs])
